...
export default function AddFileModal({
  ...
  const handleUpload = async () => {
    ...
    const newFileId =
      maxFileIdData.length > 0 ? maxFileIdData[0].file_id + 1 : 1;
    ...
    if (file) {
      ...
      if (fileType) {
        ...
        const supabaseStorageUrl =
          "https://jukuwnfgauvcbbkjnhrt.supabase.co/storage/v1/object/public/client_files/";
  ...
  return (
    <div className="add-modal-overlay">
      <div className="add-modal">
        ...
        <textarea
          name="description"
          placeholder='e.x. To be used as group image on "About Us" page to replace the current group image...'
