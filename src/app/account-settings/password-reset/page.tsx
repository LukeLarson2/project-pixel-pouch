...
export default function PasswordReset() {
  ...
  return (
    <div className='password-reset-main'>
      ...
      <div className="password-reset-modal" style={{ height: (passwordError !== '') ? "300px" : "250px" }}>
        ...
        <button className="reset-pass-btn" disabled={passwordError !== ''} onClick={handleReset}>Reset</button>
      </div>
    </div>
  )
}